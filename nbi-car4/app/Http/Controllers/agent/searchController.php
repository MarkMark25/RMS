...
class searchController extends Controller
{
    ...
    public function index()
    {
        ...
        ->get();
*/
        return view ('agent.advancedSearch',compact('showData'));
 ...
 */
    ...
    public function showCase($caseid)
    {
        ...
        $latestUpdate = DB::table('casereports')
                        ...
                        ->limit(1)
                        ->get();
        return view('agent.searchDetails',compact('cases','agent','complaintSheet','suspect','victim','nature','status','casesComplaint','whenAndWhere','count','casereport','latestUpdate'));
