  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
            ...
            <form method="POST" action="{{url('/updatedCase')}}">
                {{ csrf_field() }}
              <div class="container-fluid" style="padding-bottom:3%; padding-top:2%;">
                <div class="card mb-3" style="width:100%%;">
                  <center><div class="card-header"><h4>Edit case details</div></center>
                    <div class="card-body">
                ...
                <br>
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="">
                                    <input type="hidden" id="description" name="description" class="form-control" value="Administrator update the case information with case docketnumber = ">
