            ...
            <form method="POST" action="">
              ...
              <div class="container-fluid" style="padding-bottom:3%; padding-top:2%;">
                <div class="card mb-3" style="width:100%%;">
                  <center><div id="page-top" class="card-header"><h4>Review case details and complaint sheet</h4></div></center>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="dateEncoded" name= "dateEncoded" class="form-control"  value="{{ $cases->created_at }}" disabled>
                                </div>
                                <div class="col-md-4">
                                    <label for="">Date and Time Updated</label>
                                    <input type="text" id="dateUpdated" name= "dateUpdated" class="form-control"  value="{{ $cases->updated_Cases }}" disabled>
                                </div>
                            </div>
                        </div>
                        <hr>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                ...
                                                @if ($agent->agent_status === "Current")
                                                    <input type="text" style="background-color:#adf4c5;" id="full_name" name= "full_name" class="form-control"  value="{{ $agent->agentName}}" disabled>
                                                @else
                                                    <input type="text" style="background-color:#F48A81;" id="full_name" name= "full_name" class="form-control"  value="{{ $agent->agentName}}" disabled>
                                                @endif
                                            </div>
                                            <div class="col-md-6">
                                                <label for="agent">Date Assigned</label>
                                                @if ($agent->agent_status === "Current")
                                                <input type="text" style="background-color:#adf4c5;" id="dateAssigned" name= "dateAssigned" class="form-control"  value="{{ $agent->dateassigned}}" disabled>
                                                @else
                                                <input type="text" style="background-color:#F48A81;" id="dateAssigned" name= "dateAssigned" class="form-control"  value="{{ $agent->dateassigned}}" disabled>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach ($casesComplaint as $casesComplaint)
                                <div class="col-md-6">
                                    ...
                                    <div class="">
                                        @if ($casesComplaint->complainant_organization === null)
                                        ...
                                        @else
                                        <textarea name="complainant" id="complainant" style="width:100%;font-size:16px;resize:none;" rows="2" disabled>{{ $casesComplaint->complainant_organization}} represented by {{ $casesComplaint->complainantname}}</textarea>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-3">
                ...
                <div class="card mb-3" style="width:100%%;">
              <div class="card-header" href="#" data-toggle="modal" >Case Reports</div>
                <div class="card-body">
                  <div class="form-group">
                    <div class="table-responsive">
                      <table class="table table-striped " id="dataTable" width="100%" cellspacing="0">
                        <thead>
                          ...
                          <tr>
                            <td>
                              <a href="{{ route('getReport',[$creport->report]) }}" target="_blank" style="color:black;" onMouseOver="this.style.color='#00BFFF'" onMouseOut="this.style.color='#000000'">{{ $creport->report }}
                              </a>
                            </td>
