  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
            <a href="/advancedSearch" class="btn btn-secondary" style="margin-left:20px;">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="dateUpdated" name= "dateUpdated" class="form-control"  value="{{ $cases->updated_at }}" disabled>
                                </div>
                            </div>
                        </div>
                        <hr>
            ...
            <a class="scroll-to-top rounded" href="#page-top">
             ...
             <a href="/advancedSearch" class="btn btn-secondary" style="margin-left:20px;margin-bottom:10px;">
                <i class="fas fa-backward"></i>
                <span>Back</span>
            </a>
