  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
            <form action="/validatedData" method="POST">
                {{ csrf_field() }}
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" id="validateDocketnumber" name="validateDocketnumber" value="{{ old('validateDocketnumber') }}" class="form-control" placeholder="I-00-0000" maxlength="9" pattern="^\w{1}-\d{2}-\d{4}$" onkeypress='validate(event)' title="Follow the following format. e.g. I-10-0001" autocomplete="off"> {{-- QUERY HERE --}}
                                        </div>
                                        <div id="status"></div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" id="validateCcn" value="{{ old('validateCcn') }}" name="validateCcn" class="ccNumber form-control" placeholder="C-00-0000000000" maxlength="15" pattern="^\w{1}-\d{2}-\d{10}$" title="Follow the following format. e.g. C-10-0000000001" onkeypress='validateCCN(event)' autocomplete="off"> {{-- QUERY HERE --}}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="ccn">ACMO No.</label>
                                        <div class="input-group mb-2">
                                            <input type="text" id="validateAcmo" value="{{ old('validateAcmo') }}" name="validateAcmo" placeholder="00-C-0000000000" title="Follow the following format. e.g. 10-C-0000000001" maxlength="15" pattern="^\d{2}-\w{1}-\d{10}$" class="form-control" value="" onkeypress='validateACMO(event)' autocomplete="off"> {{-- QUERY HERE --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <hr>
            <form method="POST" action="/adminAddComplaintSheet">
                {{ csrf_field() }}
                  ...
                  <center><div class="card-header"><h4>Complaint Sheet</div></center>
                        ...
                        <div class="form-group">
                          <div class="form-row">
                              ...
                              <div class="col-md-4">
                                  ...
                                  <div class="input-group mb-2">
                                      <input type="text" id="" name="" class="form-control col-md-5" value="NBI-CCN-" readonly>
                                      <input type="text" id="ccn" name= "ccn" onkeydown="validateDocketnumber()" class="ccNumber form-control" value="{{ old('ccn') }}" placeholder="C-00-0000000000" maxlength="15" pattern="^\w{1}-\d{2}-\d{10}$" title="Follow the following format. e.g. C-10-0000000001" onkeypress='validateCCN(event)' onkeydown="validateCcnNumber()" autocomplete="off">
                                  </div>
                              </div>
                              <div class="col-md-4">
                                    <label for="ccn">ACMO No.</label>
                                    <div class="input-group mb-2">
                                        <input type="text" id="acmo" name= "acmo" onkeydown="validateDocketnumber()" value="{{ old('acmo') }}" placeholder="00-C-0000000000" title="Follow the following format. e.g. 00-C-0000000001" maxlength="15" pattern="^\d{2}-\w{1}-\d{10}$"  class="form-control" value="" onkeypress='validateACMO(event)' onkeydwon="validateAcmoNumber()" autocomplete="off">
                                    </div>
                                </div>
                          </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4">
                                ...
                                <div class="fld_wrap" id="fld2">
                                    <div class="input-group">
                                        <select name="fld_val2[]" id="fld_val2"  class="form-control selector" required>
                                            <option value=""></option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" id="datepickers" name="dateTerminated" class="form-control" value="{{ old('dateTerminated') }}" placeholder="Choose" autocomplete="off">
                                </div>
                                --}}
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" pattern=".*\S+.*" title="White-spaces is not accepted. Leave it blank if no information will be encoded." name="whereCommitted" value="{{ old('whreCommitted') }}" id="whereCommitted" class="form-control" minlength="3" maxlength="100">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" name="whenCommitted" id="whenCommitted" value="{{ old('whenCommitted') }}" class="form-control" value="" autocomplete="off"> {{-- QUERY HERE --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="control-group">
                                <div class="fld_wrap" id="fld4">
                                    <div class="input-group">
                                        ...
                                        <br>
                                        <div class="col-md-3">
                                            <input type="text" pattern=".*\S+.*" title="White-spaces is not accepted." class="form-control" id="victimNameA" name="victimNameA[]" placeholder="Name" autocomplete="off" minlength="2" maxlength="100">
                                            {{-- -<input type="text" class="form-control" name="victimNameA[]" placeholder="Name" autocomplete="off" minlength="5" maxlength="40"> --}}
                                            <input type="text" pattern=".*\S+.*" title="White-spaces is not accepted. Leave it blank if no information will be encoded." class="form-control" name="victimAgeA[]" placeholder="Age" onkeypress='validateDate(event)' autocomplete="off" minlength="1" maxlength="3">
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" pattern=".*\S+.*" title="White-spaces is not accepted. Leave it blank if no information will be encoded." class="form-control" id="victimAddressA" name="victimAddressA[]" placeholder="Address" autocomplete="off" minlength="5" maxlength="255">
                                            ...
                                            {{-- <inputtype="text"pattern=".*\S+.*"title="White-spaces is not accepted. Leave it blank if no information will be encoded."class="form-control"name="victimCivilStatusA[]"placeholder="CivilStatus"autocomplete="off"minlength="5"maxlength="20"> --}}
                                        </div>
                                        <div class="col-md-3">
                                            <input type="text" pattern=".*\S+.*" title="+ , - , and numbers are the characters only accepted." onkeypress="validateTelephone(event)" id="victimTelNumberA" name= "victimTelNumberA[]" autocomplete="off" placeholder="Telephone Number" class="ccNumber form-control" value="" autocomplete="off" minlength="5" maxlength="15">
                                            <input type="text" pattern=".*\S+.*" title="White-spaces is not accepted. Leave it blank if no information will be encoded." class="form-control" name="victimOccupationA[]" placeholder="Occupation" autocomplete="off" minlength="4" maxlength="60">
                                        </div>
                                            ...
                                            {{-- <inputtype="text"pattern=".*\S+.*"title="White-spaces is not accepted. Leave it blank if no information will be encoded."class="form-control"name="victimSexA[]"placeholder="sex"autocomplete="off"minlength="4"maxlength="6"> --}}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="">
                                    <input type="hidden" id="description" name="description" class="form-control" value="Administrator add new with docketnumber = ">
                    ...
                    <div class="form-group">
                        <center> <button class="btn btn-primary btn-block col-md-3" type="submit" onclick="validateDocketnumber();validateSeven();validateRangeAge();validateRangeHeight();validateRangeWeight();return validateCase();">Save</button> </center>
                        {{--<center> <button class="btn btn-primary btn-block col-md-3" type="submit" onclick="return validateForm();">Save</button> </center>--}}
                    </div>
