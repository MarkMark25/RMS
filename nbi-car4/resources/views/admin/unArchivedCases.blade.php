...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            <a href="/archivedRecords" class="btn btn-secondary" style="margin-left:20px;">
            ...
            <div class="container-fluid" style="padding-bottom:3%; padding-top:2%;">
                <div class="card mb-3" style="width:100%%;">
                    <form action="/processUnarchived" method="POST">
                        {{ csrf_field() }}
                        <center>
                            <div class="card-header">
                                <h4>Review the case and click <strong>"UNARCHIVE"</strong></div>
                        </center>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="">
                                            <input type="hidden" id="caseAvailability" name="caseAvailability" class="form-control" value="Available">
                                            <input type="hidden" id="descriptionOne" name="descriptionOne" class="form-control" value="Administrator unarchived the case with docketnumber = ">
                        ...
                        <div class="modal-footer">
                            <center>
                                <button type="submit" class="btn btn-primary"><strong>UNARCHIVE</strong></button>
                            </center>
                        </div>
                    </form>
                </div>
