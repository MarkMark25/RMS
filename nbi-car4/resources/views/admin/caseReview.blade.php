                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="dateEncoded" name= "dateEncoded" class="form-control"  value="{{ $cases->date_created }}" disabled>
                                </div>
                                <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="dateTerminated" name="dateTerminated" class="form-control"  value="{{ $cases->terminated_date}}" disabled>
                                </div>
                            @endforeach
                        ...
                        <section>
                            <div class="form-group">
                                ...
                                @foreach($nature as $nature)
                                    <div class="col-md-12">
                                        <input class="form-control" name="nameOfNature" id="nameOfNature"  value="{{ $nature->natureName}}" disabled>
                                    </div>
                                @endforeach
                                </div>
                            </div>
