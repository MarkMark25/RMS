<div class="form-group">
        ...
        <div class="col-md-5">
            ...
            <div class="">
            <input type="text" id="firstName" pattern=".*\S+.*" title="This field is required." name="firstName" class="form-control" value="" maxlength="50"> {{-- QUERY HERE --}}
            </div>
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-5">
            ...
            <div class="">
            <input type="text" id="lastName" pattern=".*\S+.*" title="This field is required." name="lastName" class="form-control" value="" maxlength="50"> {{-- QUERY HERE --}}
            </div>
        </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <div class="">
            <input type="text" id="username" pattern=".*\S+.*" title="This field is required." name="username" class="form-control" value="" maxlength="50"> {{-- QUERY HERE --}}
            </div>
        </div>
        <div class="col-md-6">
