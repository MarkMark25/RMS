...
<br>
      ...
      <div id="content-wrapper">
        ...
        <h1>Pending Crimes</h1>
          <div class="row">
                     <div class="col-md-2">
                        <form method="POST" action="{{ route('daterange.fetch_pending') }}" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           <b><span>Year </span></b>
                     ...
                     <div class="col-md-1">
                      <br>
                     <button type="reset" class="btn btn-primary float-left" name="refresh" id="refresh" onClick="window.location.href='/pendingCrimes'" >Refresh</button>
                     </div>
                     </form>
                  </div>
                  <br>
      ...
      <div class="card mb-3">
           <div class="card-body">
              ...
              <div class="table-responsive">
                ...
                <p></p>
                @else
                <p  style="text-align:center;">PENDING CRIME CASES FOR <b>{{$cMonth}} {{$year}}</b></p>
                 @endif
    ...
    <script type="text/javascript">
            ...
            $(document).ready(function() {
              ...
              $('#dataTable').DataTable( {
                drawCallback: function() {
                  ...
                  dom: 'Bfrtip',
                  "language": {
                  "info": "TOTAL NUMBER OF RECEIVED AND PENDING CRIME CASES: _TOTAL_",
                  "infoEmpty": "TOTAL NUMBER OF RECEIVED AND PENDING CRIME CASES: 0 ",       
                },
            ...
            'copy',
            {
                ...
                today = mm + '-' + dd + '-' + yyyy;
                return 'PENDING CRIME CASES (' + today + ')';
            },
                 messageTop: function () {
 
                    if ( cMonth === null ) {
                        return 'DETAILED REPORT OF RECEIVED AND PENDING CRIME CASES FOR ';
                    }
                    else {
                        return 'DETAILED REPORT OF RECEIVED AND PENDING CRIME CASES FOR '  +cMonth+ ' ' +year;
                    }
                },
                messageBottom: function() {
                  return 'TOTAL NUMBER OF RECEIVED AND PENDING CRIME CASES: ' +records_displayed+ '                                                                                                                                                                                         RD HECTOR EDUARD M. GEOLOGO';
                },
            ...
            },
            {
                ...
                messageBottom: function() {
                  return 'TOTAL NUMBER OF RECEIVED AND PENDING CRIME CASES: ' +records_displayed+ ' \n\n RD HECTOR EDUARD M. GEOLOGO';
                },
            },
            {
                extend: 'print',
